namespace WebServiceStudio
{
    ...
    public class UiProperties
    {
        ...
        public string MessageFontX
        {
            get
            {
                return (string) fontConverter.ConvertTo(null, null, messageFont, typeof(string));
            }
            set
            {
                messageFont = (Font) fontConverter.ConvertFrom(null, null, value);
            }
        }
        ...
        public string ReqRespFontX
        {
            get
            {
                return (string) fontConverter.ConvertTo(null, null, reqRespFont, typeof(string));
            }
            set
            {
                reqRespFont = (Font) fontConverter.ConvertFrom(null, null, value);
            }
        }
        ...
        public string WsdlFontX
        {
            get
            {
                return (string) fontConverter.ConvertTo(null, null, wsdlFont, typeof(string));
            }
            set
            {
                wsdlFont = (Font) fontConverter.ConvertFrom(null, null, value);
            }
        }
    }
}
