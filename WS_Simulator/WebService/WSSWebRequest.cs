namespace WebServiceStudio
{
    ...
    public class WSSWebRequest : WebRequest
    {
        ...
        public override WebResponse GetResponse()
        {
            ...
            try
            {
                WSSWebResponse response2 = new WSSWebResponse(webRequest.GetResponse());
        ...
        public override string ConnectionGroupName
        {
            get
            {
                return webRequest.ConnectionGroupName;
            }
            set
            {
                webRequest.ConnectionGroupName = value;
            }
        }
        ...
        public override long ContentLength
        {
            get
            {
                return webRequest.ContentLength;
            }
            set
            {
        ...
        public override bool PreAuthenticate
        {
            get
            {
                return webRequest.PreAuthenticate;
            }
            set
            {
                webRequest.PreAuthenticate = value;
            }
        }
        ...
        public override IWebProxy Proxy
        {
            get
            {
                return webRequest.Proxy;
            }
            set
            {
                webRequest.Proxy = value;
            }
        }
