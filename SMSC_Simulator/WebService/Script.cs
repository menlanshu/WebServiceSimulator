namespace WebServiceStudio
{
    ...
    internal class Script
    {
        ...
        private static readonly string usingStatementsCS = "\r\nusing System.CodeDom.Compiler;\r\nusing System.CodeDom;\r\nusing System.Collections;\r\nusing System.ComponentModel;\r\nusing System.Data;\r\nusing System.Globalization;\r\nusing System.IO;\r\nusing System.Reflection;\r\nusing System.Web.Services.Protocols;\r\nusing System.Xml.Serialization;\r\nusing System.Xml;\r\nusing System;\r\n";
        private static readonly string usingStatementsVB = "\r\nImports System.CodeDom.Compiler\r\nImports System.CodeDom\r\nImports System.Collections\r\nImports System.ComponentModel\r\nImports System.Data\r\nImports System.Globalization\r\nImports System.IO\r\nImports System.Reflection\r\nImports System.Web.Services.Protocols\r\nImports System.Xml.Serialization\r\nImports System.Xml\r\nImports System\r\n";
        ...
        private CodeExpression BuildArray(CodeStatementCollection statements, string name, object value)
        {
            ...
            {
                InitExpression = new CodeArrayCreateExpression(type.GetElementType(), array.Length)
            };
            ...
            for (int i = 0; i < array.Length; i++)
            {
                ...
                CodeExpression right = BuildObject(statements, str2 + i.ToString(), array.GetValue(i));
        ...
        private CodeExpression BuildClass(CodeStatementCollection statements, string name, object value)
        {
            ...
            CodeVariableDeclarationStatement statement = new CodeVariableDeclarationStatement(type.FullName, uniqueVariableName)
            {
                InitExpression = new CodeObjectCreateExpression(type.FullName, new CodeExpression[0])
            };
            statements.Add(statement);
            CodeVariableReferenceExpression targetObject = new CodeVariableReferenceExpression(uniqueVariableName);
            foreach (MemberInfo info in type.GetMembers(BindingFlags.Public | BindingFlags.Static | BindingFlags.Instance))
            {
                ...
                else if (info is PropertyInfo info3)
                {
                    if (!info3.CanWrite)
                    {
                        goto Label_014B;
        ...
        {
            CodeMethodInvokeExpression expression = new CodeMethodInvokeExpression(dumpMethodRef, new CodeExpression[0]);
        ...
        private void BuildMethod(CodeTypeMemberCollection members, MethodInfo method, object[] parameters)
        {
            ...
            members.Add(method2);
            CodeMethodInvokeExpression expression = new CodeMethodInvokeExpression(BuildProxy(method2.Statements, method), method.Name, new CodeExpression[0]);
            ...
            for (int i = 0; i < infoArray.Length; i++)
            {
                ...
                {
                    BuildDumpInvoke(method2.Statements, info.Name, ((CodeDirectionExpression) expression.Parameters[i]).Expression);
                }
            }
        }
        ...
        private CodeExpression BuildXmlNode(CodeStatementCollection statements, string name, object value)
        {
            ...
            if (type == typeof(XmlElement))
            {
                ...
                {
                    InitExpression = new CodeObjectCreateExpression(typeof(XmlDocument), new CodeExpression[0])
                };
                statements.Add(statement);
        ...
        private static string GetUniqueVariableName(string name, CodeStatementCollection statements)
        {
            ...
            {
                if ((statement is CodeVariableDeclarationStatement statement2) && (statement2.Name == name))
                {
        ...
        public HttpWebClientProtocol Proxy { get; set; }
