    ...
    internal class RequestProperties
    {
        ...
        public RequestProperties(HttpWebClientProtocol proxy)
        {
            if (proxy != null)
            {
                ...
                if (proxy is SoapHttpClientProtocol protocol)
                {
        ...
        public bool AllowWriteStreamBuffering
        {
            ...
            set
            {
                allowWriteStreamBuffering = value;
            }
        }
        ...
        public string HttpProxy
        {
            ...
            set
            {
                proxy = ((value == null) || (value.Length == 0)) ? null : new WebProxy(value).Address.ToString();
            }
        }
        ...
        public bool UseCookieContainer
        {
            get
            {
                return useCookieContainer;
            }
            set
            {
                useCookieContainer = value;
            }
        }
