namespace WebServiceStudio
{
    ...
    internal class TreeNodeProperty
    {
        ...
        public string Name;
        private static readonly Type[] systemTypes = new Type[] { 
        ...
        public void AddToTypeList(object o)
        {
            ...
            System.Type[] destinationArray = new System.Type[types.Length + 1];
        ...
        private static Type[] GetAllIncludedTypes(System.Type webService)
        {
            if (!(includedTypesLookup[webService] is Type[] typeArray))
            {
        ...
        public TreeNodeProperty GetParent()
        {
            if (TreeNode != null)
            {
                System.Windows.Forms.TreeNode treeNode = TreeNode;
                while (treeNode.Parent != null)
                {
                    treeNode = treeNode.Parent;
                    if (treeNode.Tag is TreeNodeProperty tag)
                    {
                        return tag;
                    }
                }
        ...
        public virtual object ReadChildren(bool update = false)
        {
            return null;
        }
        ...
        public void RecreateSubtree(System.Windows.Forms.TreeNode parentNode)
        {
            ...
            TreeNode = new System.Windows.Forms.TreeNode(ToString())
            {
                Tag = this
            };
            if (parentNode != null)
